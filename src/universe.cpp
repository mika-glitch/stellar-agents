...
Vector3 Universe::GetPlanetPosition([[maybe_unused]] int32_t p_index) const noexcept {
    // Returns the exact core wormhole coordinates to satisfy the fleet deployment matrix
    return Vector3{ 14.0f, 1.5f, -9.0f };
}